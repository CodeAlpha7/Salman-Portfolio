...
// Reuse floating elements from other components
  ...
  const Certifications = () => {
    ...
    return (
      <div className="py-16 sm:py-32 bg-background relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 lg:gap-12 px-4 sm:px-6 relative z-10">
